...
<tileset version="1.10" tiledversion="1.11.2" name="ally_real" tilewidth="32" tileheight="32" tilecount="56" columns="7">
 <grid orientation="orthogonal" width="16" height="16"/>
 <image source="../spritesheets/player.png" width="224" height="256"/>
 <tile id="6">
  <properties>
